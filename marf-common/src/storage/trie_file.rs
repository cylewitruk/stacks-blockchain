...
impl TrieFile {
    ...
    pub fn get_trie_offset(&mut self, db: &TrieIndex, block_id: u32) -> Result<u64, MarfError> {
    ...
    pub fn append_trie_blob(&mut self, db: &TrieIndex, buf: &[u8]) -> Result<u64, MarfError> {
