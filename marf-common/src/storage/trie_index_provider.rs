...
pub trait TrieIndexProvider {
    ...
    fn read_all_block_hashes_and_roots<TTrieId: MarfTrieId>(&self) -> Result<Vec<(TrieHash, TTrieId)>, MarfError>;
    fn get_confirmed_block_identifier<TTrieId: MarfTrieId>(&self, bhh: &TTrieId) -> Result<Option<u32>, MarfError>;
