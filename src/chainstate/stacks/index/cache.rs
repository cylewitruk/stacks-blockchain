...
use stacks_common::types::chainstate::{
    TrieHash, BlockHeaderHash, TRIEHASH_ENCODED_SIZE, BLOCK_HEADER_HASH_ENCODED_SIZE, 
    MARFOpenOpts, TrieHashCalculationMode, BlobCompressionType
};
...
use stacks_common::types::chainstate::{TrieCachingStrategy};
...
pub mod test {
    ...
    fn test_marf_with_cache(
        ...
        let marf_opts = MARFOpenOpts::new(hash_strategy, cache_strategy, true, BlobCompressionType::None);
    ...
    */
    ...
    fn test_marf_node_cache_everything() {
        let test_data = make_test_insert_data(128, 128);
        let root_hash = test_marf_with_cache(
            "test_marf_node_cache_everything_immediate_batch_none",
            TrieCachingStrategy::Noop,
            TrieHashCalculationMode::Immediate,
            &test_data,
            None,
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_immediate_batch_64",
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_immediate_batch_128",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(128),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_immediate_batch_67",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(67),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_immediate_batch_13",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(13),
    ...
    fn test_marf_node_cache_everything_deferred() {
        let test_data = make_test_insert_data(128, 128);
        let root_hash = test_marf_with_cache(
            "test_marf_node_cache_everything_deferred_batch_none",
            TrieCachingStrategy::Noop,
            TrieHashCalculationMode::Deferred,
            &test_data,
            None,
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_deferred_batch_64",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(64),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_deferred_batch_128",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(128),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_deferred_batch_67",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(67),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_everything_deferred_batch_13",
            TrieCachingStrategy::Everything,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(13),
    ...
    fn test_marf_node_cache_node256() {
        let test_data = make_test_insert_data(128, 128);
        let root_hash = test_marf_with_cache(
            "test_marf_node_cache_node256_immediate_batch_none",
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_immediate_batch_64",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(64),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_immediate_batch_128",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(128),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_immediate_batch_67",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(67),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_immediate_batch_13",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Immediate,
            &test_data,
            Some(13),
    ...
    fn test_marf_node_cache_node256_deferred() {
        let test_data = make_test_insert_data(128, 128);
        let root_hash = test_marf_with_cache(
            "test_marf_node_cache_node256_deferred_batch_none",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Deferred,
            &test_data,
            None,
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_deferred_batch_64",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(64),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_deferred_batch_128",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(128),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_deferred_batch_67",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(67),
        ...
        let root_hash_batched = test_marf_with_cache(
            "test_marf_node_cache_node256_deferred_batch_13",
            TrieCachingStrategy::Node256,
            TrieHashCalculationMode::Deferred,
            &test_data,
            Some(13),
